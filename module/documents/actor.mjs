import { calculateMFD } from "../helpers/utils.mjs";

/**
 * Extend the base Actor document by defining a custom roll data structure which is ideal for the Simple system.
 * @extends {Actor}
 */
export class foeActor extends Actor {
	...
	prepareBaseData() {
		...
		//systemData.special.strength.val = 
	}
	...
	_getCharacterRollData(data) {
		...
		if (data.special) {
			for (let [k, v] of Object.entries(data.special)) {
